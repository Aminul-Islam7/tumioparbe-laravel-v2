...
<div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
        <div class="user-details">
            <div class="pull-left">
                @if(Auth::user()->photo)
                    <img src="{{ asset(Auth::user()->photo) }}" alt="user-img" class="thumb-md img-circle"/>
                @else
                    <img src="{{ asset('admin/images/icon.png')}}" alt="user-img" class="thumb-md img-circle"> 
                @endif
            </div>
            <div class="user-info">
                <div class="dropdown">
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('batch.add') }}" class="waves-effect {{ set_Topmenu('batch') }}">
                        <i class="fa fa-list"></i><span> Manage Batch </span>
                    </a>
                </li>

                <li class="has_sub">
                    <a href="#" class="waves-effect {{ set_Topmenu('student') }}">
                        <i class="fa fa-dashboard"></i><span>Manage Student </span>
                        <span class="pull-right"><i class="fa fa-plus"></i></span>
                    </a>
                    <ul class="list-unstyled">
                        <li class="{{ set_Submenu('student') }}">
                            <a href="{{ route('all_students') }}">Student List</a>
                        </li>
                        <li class="{{ set_Submenu('student_enroll') }}">
                            <a href="{{ route('student.enroll_details') }}">Student Enroll List</a>
                        </li>
                    </ul>
                </li>
