                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile" id="mobile" value="{{ old('mobile') }}" placeholder="Mobile Number" class="form-control" required >
                                        @error('mobile')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="password">Confirm Password</label><small class="req"> *</small><a href="javascript:void(0)" onclick="showPassword()"><i class="fa fa-eye"></i></a>
                                        <input type="password" name="confirm_password" id="confirm_password" onkeyup="checkPass(); return false;" placeholder="Confirm Password..." class="form-control" >
