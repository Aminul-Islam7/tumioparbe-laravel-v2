                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input required name="total_seat" value="{{ $selected_info->total_seat ?? old('total_seat') }}" placeholder="Total Seat" type="number" class="form-control">
                                                @error('total_seat')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input required name="seat_left" value="{{ $selected_info->seat_left ?? old('seat_left') }}" placeholder="Seat Left" type="number" class="form-control">
                                                @error('seat_left')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input required name="group_link" value="{{ $selected_info->group_link ?? old('group_link') }}" placeholder="Group Link" type="url" class="form-control">
                                                @error('group_link')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
