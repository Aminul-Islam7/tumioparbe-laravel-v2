                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input required name="admission_fee" placeholder="Admission Fee" value="{{ $selected_info->admission_fee ?? old('admission_fee') }}" type="number" class="form-control">
                                                @error('admission_fee')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input required name="monthly_tuition_fee" value="{{ $selected_info->monthly_tuition_fee ?? old('monthly_tuition_fee') }}" placeholder="Monthly Tuition Fee" type="number" class="form-control">
