            ...
            <div class="col-md-12">
              <div class="header-tp-inr clearfix">
                ...
                <div class="header-tp-mid">
                  <p style="cursor: pointer;"> “We build your future” </p>
                </div>
                <div class="hdr-tp-rgt">
                    <div class="hdr-login">
                      <?php
                          ...
                          <?php }else{ ?>
                              <a href="{{ url('/') }}" title="Sign In"><i><img src="{{ asset('frontend/assets/images/singin-icon.png') }}" alt="singin-icon" /></i>SIGN IN</a>
                        <?php }  ?>
                    </div>
                </div>
              </div>
