            ...
            <div class="member-panel-form-wrp">
              ...
              <div class="member-panel-form">
                <div class="member-panel-form-tbs">
                    <h2>Sign up</h2>
                    <p class="auth-form-text mb-4">Already have an account? <a href="{{ url('/') }}" title="Login here">Login here</a></p>
                    ...
                    @csrf
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              <div class="form-group">
                                  <label>Mobile Number (Must be 11 digit)<span style="color:#DC3545">*</span></label>
                                  <input type="text" name="phone" id="phone" value="{{old('phone')}}" class="form-control" placeholder="Enter mobile number" />
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  <label>Age (Must be 3 to 20)<span style="color:#DC3545">*</span></label>
                      ...
                      <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                  <label>Student Unique ID <span style="color:#DC3545">*</span></label>
                                  <input type="text" name="user_name" value="{{ generateStudentUniqueID() }}" class="form-control" readonly/>
                              </div>
                            </div>
                          <div class="col-md-4">
                              <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input type="url" name="fb_link" value="" class="form-control" placeholder="Enter FB Link" />
