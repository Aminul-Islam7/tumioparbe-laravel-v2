				        ...
				        <br>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input  type="text" value="<?= $selected_info->phone; ?>" name="phone" class="form-control" id="phone" placeholder="Enter your mobile number" required>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" value="<?= $selected_info->age; ?>" name="age" class="form-control" placeholder="Enter your age" required>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Fb Link</label>
										<input type="url" value="<?= $selected_info->fb_link; ?>" name="fb_link" class="form-control" placeholder="Enter your facebook link" required>
				    ...
				    <div class="panel-body">
				        ...
				        @csrf
							...
							<div class="form-group">
				                ...
				                <input type="password" value="" name="password_confirmation" class="form-control" placeholder="Enter confirm password" required>
